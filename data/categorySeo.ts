export interface CategorySeoData {
  ...
  whyChooseSBPatternWorks: string;
...
export const categorySeoMap: Record<string, CategorySeoData> = {
  'door-hardware': {
    ...
    fullGuideContent: `
SB PATTERN WORKS Architectural Hardware stands as a premier Indian brass hardware manufacturer and exporter, operating an integrated foundry and precision machine shop in Aligarh, Uttar Pradesh. For decades, our foundry has supplied international architectural ironmongers, hardware distributors, and OEM brands with solid brass door handles, mortise lever sets, grand entrance knobs, heavy-duty security barrel bolts, and period-correct rim locks.
...
SB PATTERN WORKS door hardware is engineered to comply with BS EN 1906 mechanical endurance standards (tested beyond 200,000 operational cycles) and ISO 9227 neutral salt spray corrosion chamber testing. We handle complete export logistics, offering FCL/LCL container shipping, custom palletization, and OEM private label packaging.
    `,
    faqs: [
      {
        question: 'What brass alloy is used in SB PATTERN WORKS door hardware manufacturing?',
        answer:
      ...
      {
        question: 'Can SB PATTERN WORKS supply custom spindle sizes and center-to-center (CTC) measurements for door handles?',
        answer:
      ...
      {
        question: 'How does SB PATTERN WORKS package door hardware for export shipping?',
        answer:
  ...
  'door-accessories': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS manufactures precision architectural door accessories, including Euro profile escutcheons, oval keyhole plates, bathroom turn-and-release latches, security door chains, and heavy-duty flush bolts in Aligarh, India.',
    materialsUsed:
    ...
    fullGuideContent: `
Architectural door accessories form the essential finishing touches of any complete ironmongery specification. SB PATTERN WORKS manufactures an extensive range of solid brass keyhole escutcheons, Euro profile rose covers, bathroom privacy turn & release mechanisms, heavy-duty flush bolts, and security restrictor chains in Aligarh, India.
...
Cast from solid brass, our escutcheons and turn releases feature substantial wall thickness to eliminate flexing during installation. Screws and fixings are color-matched and lacquered to ensure long-term aesthetic cohesion with lever handles and pull bars.
    ...
    faqs: [
      {
        question: 'Are SB PATTERN WORKS escutcheons compatible with standard Euro profile cylinders?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Yes, all SB PATTERN WORKS bathroom turn and release mechanisms feature an exterior coin-turn emergency release for safety compliance.',
      },
    ],
  },
  ...
  'railing-fittings': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS produces heavy-duty solid brass, bronze, and stainless steel handrail brackets, glass balustrade clamps, end caps, and wall mounts for staircases, balconies, and architectural handrails.',
    materialsUsed:
    ...
    fullGuideContent: `
Staircases and balcony railings require hardware that combines architectural elegance with unyielding structural load capacity. SB PATTERN WORKS manufactures premium handrail brackets, glass clamps, rail end caps, and post connectors in Aligarh, India.
...
Whether specified in Mirror Polished Brass, Satin Brushed Stainless Steel, or Antique Bronze, our railing fittings undergo rigorous multi-stage hand polishing to achieve flawless reflective surfaces and smooth tactile curves.
    ...
    faqs: [
      {
        question: 'What weight capacity do SB PATTERN WORKS handrail brackets support?',
        answer:
          'SB PATTERN WORKS heavy-duty handrail brackets are engineered to meet international building codes, supporting concentrated loads of over 1.5 kN when anchored properly to solid masonry or timber studs.',
      },
    ],
  },
  ...
  'cabinet-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS manufactures luxury cabinet pull handles, knurled bar pulls, bin cup pulls, turned brass drawer knobs, and concealed furniture hinges in Aligarh, Uttar Pradesh.',
    materialsUsed:
    ...
    fullGuideContent: `
Cabinet hardware is the jewelry of high-end interior architecture. SB PATTERN WORKS manufactures an extensive catalog of solid brass cabinet pulls, knurled bar handles, classic bin cup pulls, and turned drawer knobs for bespoke kitchen joiners, furniture makers, and interior specifiers.
...
We manufacture cabinet pulls in standard metric hole centers ranging from 96mm up to 600mm appliance pulls. Each handle includes break-off M4 mounting screws to accommodate various cabinet door thicknesses from 18mm to 35mm.
    ...
    faqs: [
      {
        question: 'Can SB PATTERN WORKS manufacture custom length appliance pulls for kitchens?',
        answer:
      ...
      {
        question: 'What mounting hardware is supplied with SB PATTERN WORKS cabinet knobs and pulls?',
        answer:
  ...
  'window-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS manufactures traditional and modern window fittings, including casement peg stays, quadrant sash fasteners, Fitch sash locks, espagnolette handles, and window friction hinges in Aligarh, India.',
    materialsUsed:
    ...
    fullGuideContent: `
Window hardware must withstand atmospheric exposure while providing smooth, effortless operation. SB PATTERN WORKS manufactures solid brass casement peg stays, sash window fasteners, Espagnolette handles, and friction stays designed for timber, aluminum, and steel fenestrations.
...
Recognizing that window hardware is constantly exposed to direct sunlight and moisture, our products are treated with UV-resistant clear coats, hand-waxed antique patinas, or marine-grade PVD coatings.
    ...
    faqs: [
      {
        question: 'Are SB PATTERN WORKS window stays suitable for heavy double-glazed timber windows?',
        answer:
  ...
  'nautical-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS produces marine-grade solid brass and 316 stainless steel nautical hardware, including mooring cleats, porthole fasteners, hatch latches, and marine boat fittings.',
    materialsUsed:
    ...
    fullGuideContent: `
Saltwater marine environments represent the ultimate test of hardware durability. SB PATTERN WORKS manufactures marine-grade solid naval brass and 316 stainless steel nautical fittings designed for yachts, coastal estates, and maritime applications.
...
Our nautical hardware uses naval brass containing specific zinc and tin ratios that prevent dezincification in marine environments. Every product line undergoes rigorous ISO 9227 salt spray testing to verify coating integrity and metal resistance against harsh marine atmospheres.
    ...
    faqs: [
      {
        question: 'Is SB PATTERN WORKS nautical hardware suitable for saltwater environments?',
        answer:
  ...
  'decorative-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS manufactures hand-cast decorative brass hooks, ornate wall accents, decorative metal grilles, embossed sign plates, and decorative brass hardware in Aligarh, India.',
    materialsUsed:
    ...
    fullGuideContent: `
Decorative architectural hardware adds distinct character and visual interest to luxury interior spaces. SB PATTERN WORKS manufactures hand-cast brass wall hooks, decorative grilles, embossed sign plates, and tactile hardware accents in Aligarh, India.
...
For highly detailed organic shapes and historical filigree, our artisans use lost-wax investment casting and hand-chasing. Each piece is polished by hand, capturing light across complex facets and highlighting hand-applied patinas.
    ...
    faqs: [
      {
        question: 'Do SB PATTERN WORKS decorative wall hooks come with mounting hardware?',
        answer:
  ...
  'bathroom-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS manufactures solid brass bathroom hardware, including towel bars, robe hooks, paper holders, glass shelf brackets, and shower door pulls in Aligarh, India.',
    materialsUsed:
    ...
    fullGuideContent: `
Bathroom accessories must withstand constant humidity and exposure to water without rusting or tarnishing. SB PATTERN WORKS manufactures 100% solid brass bathroom fittings designed for high-end residential and hotel bathrooms.
...
Our bathroom collection features heavy-duty concealed mounting brackets that eliminate visible screws while ensuring rigid wall attachment. Heavy-gauge brass tubing resists bending, while PVD finishes protect against moisture damage.
  ...
  'curtain-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS produces solid brass curtain poles, finials, drapery brackets, curtain rings, and holdbacks for luxury window treatments.',
    materialsUsed:
    ...
    fullGuideContent: `
Luxury drapery requires robust, elegant hardware capable of supporting heavy fabrics. SB PATTERN WORKS manufactures solid brass curtain poles, hand-carved finials, heavy drapery brackets, and smooth-gliding curtain rings in Aligarh, India.
...
Our curtain poles feature heavy-wall seamless drawn brass tubing that resists deflection across wide spans. We manufacture modular internal joiners to allow seamless extensions for grand estate windows.
    ...
    faqs: [
      {
        question: 'What curtain pole diameters does SB PATTERN WORKS manufacture?',
        answer:
  ...
  'gate-fence-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS manufactures heavy-duty wrought iron and solid brass gate latches, drop bolts, strap hinges, and perimeter security hardware.',
    materialsUsed:
    ...
    fullGuideContent: `
Perimeter gates require heavy-duty hardware that withstands constant outdoor exposure, heavy impacts, and gate movement. SB PATTERN WORKS manufactures hand-forged ironmongery, heavy strap hinges, Suffolk latches, and drop bolts in Aligarh, India.
...
Our gate hardware is forged by blacksmiths and finished with multi-layer anti-rust treatments, including zinc phosphate priming, black e-coating, and UV-stable exterior powder coating.
    ...
    faqs: [
      {
        question: 'Is SB PATTERN WORKS gate hardware rust-resistant for outdoor installation?',
        answer:
  ...
  'structural-hardware': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS produces structural architectural hardware, heavy timber connectors, tie rods, parliament hinges, and structural brackets in Aligarh, India.',
    materialsUsed:
    ...
    fullGuideContent: `
Structural architectural fittings demand precise engineering and certified material strength. SB PATTERN WORKS manufactures heavy timber connectors, parliament hinges, structural brackets, and tie rods designed for heavy timber framing and architectural metalwork.
...
Our structural hardware is subjected to destructive tension and shear load testing. We provide Material Test Certificates (MTC) verifying chemical composition and mechanical properties for commercial specification compliance.
    ...
    faqs: [
      {
        question: 'Does SB PATTERN WORKS provide Material Test Certificates (MTC) for structural hardware?',
        answer:
  ...
  'custom-bespoke': {
    ...
    manufacturingOverview:
      'SB PATTERN WORKS offers direct OEM/ODM contract manufacturing, custom brass casting, 3D CAD pattern tooling, and private label hardware production in Aligarh, India.',
    materialsUsed:
    ...
    fullGuideContent: `
SB PATTERN WORKS is a trusted OEM contract manufacturer for international hardware brands, architectural specifiers, and design houses worldwide. Operating our own brass foundry and CNC machining facility in Aligarh, India, we turn client CAD drawings and physical prototypes into finished hardware products.
...
We operate under strict Non-Disclosure Agreements (NDAs) to protect proprietary client designs. Products can be laser-marked with custom brand logos, packaged in client-branded retail boxes, and shipped directly to global distribution centers.
    ...
    faqs: [
      ...
      {
        question: 'How fast can SB PATTERN WORKS produce initial samples from a CAD drawing?',
        answer:
